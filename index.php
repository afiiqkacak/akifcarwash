...
$tar= date("Y-m-d");?>
			...
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link active" href="index.php">Queue <i class="fa fa-car" aria-hidden="true"></i></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="services.php">Services <i class="fa fa-wrench" aria-hidden="true"></i></a>
				</li>
				<li class="nav-item">
